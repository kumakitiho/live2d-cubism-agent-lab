...
3. `$image-to-live2d-assets` を使い、素材計画、並列queue、manifest、layer map、import PSDを準備する。
...
6. Cubism評価で問題がなければ、結果と残る目視QAを記録する。
7. 素材由来の問題があれば `asset_feedback.yaml` を作り、validatorを通す。
